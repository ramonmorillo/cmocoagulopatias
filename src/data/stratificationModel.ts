...
export const MODEL:Variable[]=[
 {id:'age',number:1,name:'Edad',description:'Modelo para población adulta.',dimension:'demographic',options:[{value:'minor',label:'Menor de 18 años',points:0},{value:'18-50',label:'18–50 años',points:1},{value:'over50',label:'Mayor de 50 años',points:2}]},
 ...
 {id:'comorbidities',number:10,name:'Comorbilidades',description:'VIH, VHC, cáncer, ictus, cardiovascular, diabetes, osteoporosis, renal, etc.',dimension:'clinical',options:yn(1)},
 {id:'degenerative_joint',number:11,name:'Patología articular degenerativa',description:'Presencia documentada.',dimension:'clinical',options:yn(2)},
 {id:'psychological',number:12,name:'Problemas psicológicos',description:'Ansiedad, depresión u otros problemas de salud mental.',dimension:'clinical',options:yn(3),interview:true},
 {id:'advanced_therapy',number:13,name:'Agente hemostásico: terapia avanzada',description:'Terapia génica u otra terapia avanzada disponible; obliga a Prioridad 1.',dimension:'pharmacotherapeutic',options:yn(0)},
 {id:'route',number:14,name:'Vía de administración',description:'Vía del tratamiento actual.',dimension:'pharmacotherapeutic',options:[{value:'other',label:'Otras / no aplicable',points:0},{value:'both',label:'Subcutánea + intravenosa',points:1},{value:'iv',label:'Intravenosa',points:2}]},
 {id:'regimen_changes',number:15,name:'Cambios desde última dispensación',description:'Cambios en dosis, pauta o dosis adicionales.',dimension:'pharmacotherapeutic',options:[{value:'none',label:'Sin cambios',points:0},{value:'dose',label:'Cambio de dosis o pauta',points:2},{value:'extra',label:'Dosis adicionales/modificación puntual',points:3}]},
 {id:'home_delivery',number:16,name:'Dispensación domiciliaria',description:'Entrega en domicilio u oficina de farmacia sin visita presencial.',dimension:'pharmacotherapeutic',options:yn(1)},
 {id:'prophylaxis',number:17,name:'Régimen profiláctico',description:'Profilaxis primaria, secundaria o terciaria.',dimension:'pharmacotherapeutic',options:yn(3)},
 {id:'nonadherence',number:18,name:'Falta de adherencia',description:'Adherencia o persistencia subóptima según dispensaciones/HCE.',dimension:'pharmacotherapeutic',options:yn(4),interview:true},
 {id:'socioeconomic',number:19,name:'Entorno familiar / situación socioeconómica',description:'Condiciones desfavorables, aislamiento, dependencia o ausencia de apoyo.',dimension:'social',options:yn(3),interview:true},
 {id:'lifestyle',number:20,name:'Estilo de vida',description:'Puede registrar simultáneamente actividad física intensa y riesgo cardiovascular.',dimension:'social',multi:true,interview:true,options:[{value:'intense',label:'Actividad física intensa',points:1},{value:'cv_risk',label:'Uno o más factores de riesgo cardiovascular',points:2}]},
 {id:'access',number:21,name:'Dificultades de acceso hospitalario',description:'Viajes, dependencia, recursos, comorbilidades u organización.',dimension:'social',options:yn(2)},
 {id:'knowledge',number:22,name:'Conocimiento limitado de la enfermedad',description:'Puede afectar al autocuidado o las decisiones.',dimension:'social',options:yn(3),interview:true},
 {id:'transition',number:23,name:'Transición pediátrico-adulto',description:'Paciente en transición al ámbito adulto.',dimension:'social',options:yn(4)},
 {id:'quality_life',number:24,name:'Calidad de vida (variable adicional)',description:'Baja calidad de vida según SF-36, EQ-5D, Haemo-QoL-A u otro cuestionario validado. No formó parte del pretest de los puntos de corte.',dimension:'clinical',options:yn(1),optional:true}
];
